...
let distPath = projectConfig.path.dist || './assets/';
...
gulp.task('minify:css', function() {
  ...
  return gulp.src(distPath + 'dist/*.css')
    .pipe(cleanCSS())
...
gulp.task('build-dev', function(callback) {
  gulpSequence(
    'clean',
    ['style', 'copy:scripts', 'copy:images', 'copy:fonts', 'copy:php', 'copy:css', 'concat:scripts', 'concat:styles'],
    'html',
    callback
  );
});
...
gulp.task('build', function(callback) {
  gulpSequence(
    'clean',
    ['style-build', 'copy:scripts', 'copy:images', 'copy:fonts', 'copy:php', 'copy:css', 'concat:scripts', 'concat:styles'],
